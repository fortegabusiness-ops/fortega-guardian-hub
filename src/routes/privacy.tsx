...
const DESC =
  "How Fortega Security Inc. collects, uses, stores and protects personal information across our Canadian security services and website.";
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 pb-20 pt-28 md:pt-32">
      ...
      <div className="mt-8 space-y-6 text-foreground">
        <p>
          Fortega Security Inc. ("Fortega", "we", "us") respects your privacy and is committed
